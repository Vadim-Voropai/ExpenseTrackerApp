...
import com.vvv.openexpensetracker.data.source.local.AndroidSecureStorage
...
actual fun getPlatformModule(): Module = module {
    ...
    single<GoogleAuthRepository> { GoogleAuthRepositoryImpl(get(), get(named("baseHttpClient")), get()) }
}
